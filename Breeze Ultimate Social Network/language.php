...
foreach($language as $avail_lang) {
    ...
    if($path['filename'] == $set_lang) {
	    $availables .= '<a style="text-decoration:none;" href="'.$TEXT['installation'].'/index.php?lang='.$path['filename'].'" class="brz-margin-top-small brz-left brz-padding brz-round brz-pink-light brz-margin-left-small">'.ucfirst($path['filename']).'</a>';			
	} else {
	    $availables .= '<a style="text-decoration:none;" href="'.$TEXT['installation'].'/index.php?lang='.$path['filename'].'" class="brz-margin-top-small brz-left brz-padding brz-round brz-light-grey brz-text-grey brz-margin-left-small brz-hover-opacity">'.ucfirst($path['filename']).'</a>';	
	}

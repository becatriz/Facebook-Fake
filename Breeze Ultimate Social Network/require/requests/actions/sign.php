...
if(isset($_POST['v1']) && !empty($_POST['v1']) && isset($_POST['v2']) && !empty($_POST['v2']) && isset($_POST['v3']) && !empty($_POST['v3']) && isset($_POST['v5']) ) {
	...
	if($_POST['v3'] !== $_POST['v4'] ) {
			echo '<script>
			            captcha();	
                        switchPage(\'#animated-loader-page\',\'#password-page\');
    ...
    // Check UserName character length	
			...
			echo '<script>
			            captcha();	
                        switchPage(\'#animated-loader-page\',\'#username-page\');
	...
	// Check EMail format	
			...
			echo '<script>
			            captcha();
                        switchPage(\'#animated-loader-page\',\'#email-page\');
	...
	// CAPTCHA test			
			...
			echo '<script>
			            captcha();
                        switchPage(\'#animated-loader-page\',\'#captcha-page\');
	...
	// Gender test			
			...
			echo '<script>
			            captcha();
                        switchPage(\'#animated-loader-page\',\'#gender-page\');
	...
	// First name and last name test			
			...
			echo '<script>
			            captcha();
                        switchPage(\'#animated-loader-page\',\'#name-page\');
		...
		if($signed) {
		    ...
		    // Check status
			if($data == 1) {
				echo '<script>location.reload();</script>'; // If logged

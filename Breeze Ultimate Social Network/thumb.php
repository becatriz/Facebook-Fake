...
if(!empty($_GET['fol'])) {
	if($_GET['fol'] == 'a') {
		$type = 'uploads/profile/main';
		$quality_list = array(50, 75, 100);
	} elseif($_GET['fol'] == 'b') {
		$type = 'uploads/profile/covers';
		$quality_list = array(50, 75, 100);
	} elseif($_GET['fol'] == 'f') {
		$type = 'uploads/groups';
		$quality_list = array(50, 75, 100);
	} elseif($_GET['fol'] == 'pb') {
		$type = 'uploads/pages/covers';
		$quality_list = array(50, 75, 100);
	} elseif($_GET['fol'] == 'pa') {
		$type = 'uploads/pages/main';
		$quality_list = array(50, 75, 100);
	} elseif($_GET['fol'] == 'c') {
		$type = 'uploads/posts/photos';
		$quality_list = array(50, 75, 100);
	} elseif($_GET['fol'] == 'd') {
		$type = 'uploads/chats/icons';
		$quality_list = array(50, 75, 100);
	} elseif($_GET['fol'] == 'bb') {
		$type = 'uploads/posts/backgrounds';
		$quality_list = array(50, 75, 100);
	} elseif($_GET['fol'] == 'e') {
		$type = 'uploads/chats/covers';
		$quality_list = array(50, 75, 100);
	} elseif($_GET['fol'] == 'i') {
		$type = 'themes/'.$_GET['theme'].'/img/icons/post';
		$quality_list = array(50, 75, 100);
	} else {
		exit('URL error 4S32B');
	}
} else {
	exit('URL error 4S32A');
}

// Use Installation URL
$_GET['src'] = $TEXT['installation'].'/'.$type.'/'.$_GET['src']; 
